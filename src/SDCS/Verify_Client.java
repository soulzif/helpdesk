 ...
 * @author Zifan
 */
public class Verify_Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        vadd = new javax.swing.JTextArea();
        ...
        rej = new javax.swing.JRadioButton();
        ...
        getContentPane().add(vname, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, 240, -1));
        getContentPane().add(vc, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 150, 240, -1));
        ...
        getContentPane().add(vdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 410, 240, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel8.setText("Address");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 320, -1, -1));
        getContentPane().add(cidd, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, 70, 30));
        ...
        vadd.setColumns(20);
        vadd.setRows(5);
        jScrollPane1.setViewportView(vadd);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 320, 240, 79));
        ...
        getContentPane().add(vemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, 240, -1));
        ...
        getContentPane().add(acc, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 510, 90, -1));
        ...
        getContentPane().add(rej, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 510, 90, -1));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 450, -1, -1));

        Aptype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "select", "Brandnew", "Repair" }));
        getContentPane().add(Aptype, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 450, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String nid=cidd.getText();
        if(acc.isSelected())
        {
            JOptionPane.showMessageDialog(this,"Project Approved");
               this.dispose();
        }
        else if(rej.isSelected())
        {
            try{
                  DConnection c = new DConnection();
                  String str = "DELETE FROM client WHERE  ClientID= '"+nid+"'";
        ...
        try {
            ...
            while (rs.next()) {
              ...
              if("Male".equals(add2)){
               ...
               vadd.setText(rs.getString("Address"));  
                 vdate.setDate(rs.getDate("Admission_Date"));
    ...
    private javax.swing.JRadioButton rej;
    private javax.swing.JTextArea vadd;
